// Compact MD5 over a byte array. RFC 1321. MD5 is not in the Web Crypto API,
// so it is implemented here; SHA-1/256/384/512 use crypto.subtle instead.
// MD5 is cryptographically broken — offered for checksums and legacy interop only.
